...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5em; margin: 1.5em 0;">
  ...
  <figure style="text-align: center; margin: 0;">
    <img src="/ip.png" style="width: 100%; height: 220px; object-fit: contain; background: white; border-radius: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <figcaption style="margin-top: 0.5em; font-size: 0.9em;">
      <span class="fall">Fall 2026</span>: <a href="/fa_26_drp.pdf" target="_blank">Inverse Problems and Data Assimilation</a>
    </figcaption>
  </figure>

  <figure style="text-align: center; margin: 0;">
    <img src="/gp.png" style="width: 100%; height: 220px; object-fit: cover; border-radius: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <figcaption style="margin-top: 0.5em; font-size: 0.9em;">
      <span class="spring">Spring 2027</span>: Gaussian Processes and Applications <em>(tentative)</em>
    </figcaption>
  </figure>

  <figure style="text-align: center; margin: 0;">
    <img src="/rmt.jpg" style="width: 100%; height: 220px; object-fit: cover; border-radius: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <figcaption style="margin-top: 0.5em; font-size: 0.9em;">
      <span class="fall">Fall 2027</span>: Matrix Concentration Inequalities <em>(tentative)</em>
    </figcaption>
  </figure>

  <figure style="text-align: center; margin: 0;">
    <div style="width: 100%; height: 220px; background: #f0f0f0; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: #aaa; font-size: 0.9em;">TBD</div>
    <figcaption style="margin-top: 0.5em; font-size: 0.9em;">
      <span class="spring">Spring 2028</span>: Percolation Theory
    </figcaption>
  </figure>
